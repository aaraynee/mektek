...
?>
	<a href="<?php echo esc_url( $link ) ?>" rel="nofollow" target="_blank" title="<?php esc_attr_e( 'Advertisment', 'auto-repair' ) ?>"><?php wpv_lazy_load( $image, __( 'Advertisement', 'auto-repair' ) )?></a>
<?php
endfor;
