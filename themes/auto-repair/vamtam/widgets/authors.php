...
class wpv_authors extends WP_Widget {
	...
	public function wpv_authors() {
		$widget_opts = array(
			...
			'description' => __( 'List of authors and their descriptions', 'auto-repair' )
			);
		$this->WP_Widget( 'wpv_authors', __( 'Vamtam - Authors', 'auto-repair' ), $widget_opts );
	}
	...
	public function widget($args, $instance) {
	  ...
	  'show_post_count' => '',
		...
		$title = apply_filters( 'widget_title', empty($instance['title']) ? __( 'Authors', 'auto-repair' ) : $instance['title'], $instance, $this->id_base );
