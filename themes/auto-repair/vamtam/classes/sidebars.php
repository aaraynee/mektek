...
class WpvSidebars {
	...
	public function __construct() {
		$this->sidebars = array(
			'page' => __( 'Shared Page Widget Area', 'auto-repair' ),
			'blog' => __( 'Blog Widget Area', 'auto-repair' ),
			'portfolio' => __( 'Portfolio Widget Area', 'auto-repair' ),
		);

		if ( wpv_has_woocommerce() )
			$this->sidebars['wpv-woocommerce'] = __( 'WooCommerce Widget Area', 'auto-repair' );
