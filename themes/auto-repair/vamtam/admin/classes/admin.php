...
class WpvAdmin {
	...
	public static function actions() {
		self::$option_pages = array(
			'general' => array(
				__( 'VamTam | General Settings', 'auto-repair' ),
				__( 'General Settings', 'auto-repair' ),
			),

			'layout' => array(
				__( 'VamTam | Layout', 'auto-repair' ),
				__( 'Layout', 'auto-repair' ),
			),

			'styles' => array(
				__( 'VamTam | Styles', 'auto-repair' ),
				__( 'Styles', 'auto-repair' ),
			),

			'import' => array(
				__( 'VamTam | Quick Import', 'auto-repair' ),
				__( 'Quick Import', 'auto-repair' ),
			),

			'help' => array(
				__( 'VamTam | help', 'auto-repair' ),
				__( 'Help', 'auto-repair' ),
			),
		);
	...
	public static function icons_selector() {
		...
		<div class="wpv-config-icons-selector hidden">
			<input type="search" placeholder="<?php esc_attr_e( 'Filter icons', 'auto-repair' ) ?>" class="icons-filter"/>
	...
	public static function load_metaboxes( $post_id = null ) {
		$config = array(
			...
			'title' => __( 'VamTam Testimonials', 'auto-repair' ),
		...
		$config = array(
			...
			'title' => __( 'VamTam Post Formats', 'auto-repair' ),
			'pages' => array( 'post' ),
			'context' => 'normal',
			'priority' => 'high',
			'post_id' => $post_id,
		...
		$config = array(
			...
			'title' => __( 'VamTam Portfolio Formats', 'auto-repair' ),
		...
		$config = array(
			...
			'title' => __( 'VamTam Portfolio Format', 'auto-repair' ),
			'pages' => array( 'portfolio' ),
			'context' => 'side',
			'priority' => 'high',
			'post_id' => $post_id,
		...
		$config = array(
			...
			'title' => __( 'VamTam Options', 'auto-repair' ),
