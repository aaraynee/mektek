...
class WPV_Editor {
	...
	public function admin_init() {
		...
		foreach ( $post_types as $type ) {
			add_meta_box( 'wpv_visual_editor', __( 'Visual Editor', 'auto-repair' ), array( &$this, 'editor' ), $type, 'advanced', 'low' );
		}
	...
	public function enqueues() {
	  ...
	  'empty_notice' => __( 'Please drag  any element you want here.', 'auto-repair' ),
			) );
	}
							...
							<?php if ( isset( $wpv_sc[$slug]['desc'] ) ) : ?>
								<div class="description">
									...
									<div>
										...
										<footer><a href="<?php echo esc_attr( admin_url( 'admin.php?page=wpv_help' ) ) ?>" title="<?php _e( 'Read more in our documentation', 'auto-repair' ) ?>"><?php _e( 'Read more in our documentation', 'auto-repair' ) ?></a></footer>
									</div>
								</div>
							<?php endif ?>
						</li>
